...
export default function HalamanKeuangan() {
  ...
  // Panggil fetchTransactions saat komponen mount
  useEffect(() => {
    fetchTransactions();
  }, []);
  ...
  // Hitung summary menggunakan useMemo
                            ...
                            <div>
                                ...
                                <Popover>
                                    ...
                                    >
                                        ...
                                        {formData.tanggal ? format(formData.tanggal, "PPP", { locale: id }) : <span>Pilih tanggal</span>}
                                    </Button>
                                    </PopoverTrigger>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <Input
                                    id="jumlah"
                                    name="jumlah"
                                    type="text" // Gunakan text agar bisa format, tapi simpan as number
                    ...
                    <TableBody>
                        {loading ? (
                            ...
                            filteredTransactions.map((t) => (
                                <TableRow key={t.id}>
                                    <TableCell>{format(new Date(t.tanggal), 'dd MMM yyyy', { locale: id })}</TableCell>
